...
from . import views
from .views import CompetencyView, QuestionView, QuestionnaireView,AssessmentView,QuestionsForAssessment,AssessmentStatusOrEndDataChange,AssessmentsOfParticipant,AddParticipantObserverToAssessment
