...
urlpatterns =[
    ...
    path('sessions/past/<str:user_type>/<int:user_id>/',views.get_past_sessions_of_user),
    ...
    path('session/request/chemistry/<int:project_id>/<int:learner_id>/',views.request_chemistry_session),
    path('session/<int:project_id>/<int:learner_id>/',views.get_learner_sessions_in_project),
