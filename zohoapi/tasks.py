...
def create_so_with_line_items(salesorder_id):
    try:
        ...
        print(salesorder_id, print(str(e)))
...
def create_po_with_line_items(purchase_order_id, is_guest_ctt=False):
    try:
        ...
        print(purchase_order_id, print(str(e)))
...
def create_client_invoice_with_line_items(clientinvoice_id):
    try:
        ...
        print(clientinvoice_id, print(str(e)))
...
def update_so_with_line_items(salesorder_id):
    try:
        ...
        line_item_ids_to_remove = list(
            set(existing_line_item_ids) - set(new_line_item_ids)
        )
